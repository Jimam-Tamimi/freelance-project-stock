    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_portfolio_value', models.FloatField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('watchlist_name', models.CharField(blank=True, max_length=128, null=True)),
                ('watchlist_description', models.TextField(blank=True, max_length=2000, null=True)),
                ('watchlist_live_quotes', models.BooleanField(default=True)),
                ('watchlist_update_every', models.IntegerField(default=10, null=True)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified', models.DateTimeField(auto_now_add=True, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regularMarketPrice', models.DecimalField(decimal_places=2, default=0, max_digits=15, null=True, verbose_name='Price')),
                ('cost', models.DecimalField(decimal_places=2, default=0, max_digits=15, null=True, verbose_name='Net Total')),
                ...
                ('update_cash_balance', models.BooleanField(default=True, verbose_name='Update the Cash balance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('symbol', models.CharField(max_length=20, verbose_name='Symbol')),
                ('start_price', models.DecimalField(decimal_places=2, default=0, max_digits=15, null=True, verbose_name='Start Price')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified', models.DateTimeField(auto_now_add=True, null=True)),
                ('watchlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wathcliststocks', to='dashboard.watchlist')),
            ],
            options={
                'ordering': ['-symbol'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tablename', models.CharField(max_length=50, null=True, verbose_name='TableName')),
                ('columnsvisible', models.CharField(max_length=500, null=True, verbose_name='ColumnsVisible')),
                ('columnsorder', models.CharField(max_length=500, null=True, verbose_name='ColumnsOrder')),
                ('columnsreorder', models.CharField(max_length=500, null=True, verbose_name='ColumnsReorder')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
