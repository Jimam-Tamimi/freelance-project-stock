    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('netIncome', models.DecimalField(decimal_places=2, default=0, max_digits=15, null=True, verbose_name='Net Profit')),
                ...
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stockdetails', to='dashboard.stock')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('buyPrice', models.DecimalField(decimal_places=2, default=0, max_digits=15, null=True, verbose_name='Buy Price')),
                ...
                ('stockdetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.stockdetail')),
            ],
        ),
    ]
